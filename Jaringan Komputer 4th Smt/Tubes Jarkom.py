...
if '__main__' == __name__:
  ...
  net.addLink(r2,r4,cls=TCLink, **bwlink2) #r2-eth1 r4-eth0
  ...
  h1.cmd("tp route add default via 10.0.1.1 dev h1-eth1 table 2") 
  h1.cmd("ip route add default scope global nexthop via 10.0.0.1 dev h1-eth0")
  h1.cmd("ip route add default scope global nexthop via 10.0.1.1 dev h1-eth1")
  
  h2.cmd("ip rule add from 10.0.4.2 table 1") 
  h2.cmd("ip rule add from 10.0.5.2 table 2") 
  ...
  h2.cmd("tp route add default via 10.0.5.1 dev h2-eth1 table 2") 
  h2.cmd("ip route add default scope global nexthop via 10.0.4.1 dev h2-eth0")
  h2.cmd("ip route add default scope global nexthop via 10.0.5.1 dev h2-eth1") 
  
  r1.cmd("router add -net 10.0.1.0/24 gw 10.0.2.2")
  r1.cmd("router add -net 10.0.3.0/24 gw 10.0.6.2")
  r1.cmd("router add -net 10.0.4.0/24 gw 10.0.2.2")
  r1.cmd("router add -net 10.0.5.0/24 gw 10.0.6.2")
  r1.cmd("router add -net 10.0.7.0/24 gw 10.0.2.2")
  
  r3.cmd("router add -net 10.0.0.0/24 gw 10.0.7.2")
  r3.cmd("router add -net 10.0.2.0/24 gw 10.0.7.2")
  r3.cmd("router add -net 10.0.4.0/24 gw 10.0.7.2")
  r3.cmd("router add -net 10.0.5.0/24 gw 10.0.3.2")
  r3.cmd("router add -net 10.0.6.0/24 gw 10.0.3.2")
  
  r2.cmd("router add -net 10.0.0.0/24 gw 10.0.2.1")
  r2.cmd("router add -net 10.0.1.0/24 gw 10.0.7.1")
  r2.cmd("router add -net 10.0.3.0/24 gw 10.0.7.1")
  r2.cmd("router add -net 10.0.5.0/24 gw 10.0.7.1")
  r2.cmd("router add -net 10.0.6.0/24 gw 10.0.2.1")
  
  r4.cmd("router add -net 10.0.0.0/24 gw 10.0.6.1")
  r4.cmd("router add -net 10.0.1.0/24 gw 10.0.2.1")
  r4.cmd("router add -net 10.0.2.0/24 gw 10.0.6.1")
  r4.cmd("router add -net 10.0.4.0/24 gw 10.0.6.1")
  r4.cmd("router add -net 10.0.7.0/24 gw 10.0.2.1")
